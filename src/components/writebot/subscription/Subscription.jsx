...
const Subscription = () => {
  ...
  return (
    <>
       <section className="pricing-section-5 section-space-top section-space-sm-bottom">
    <Tabs>
    ...
    <img src="/img/pricing-section-5-shape-top.png" alt="image" className="img-fluid pricing-section-5-shape pricing-section-5-shape-top"/>
    <img src="/img/pricing-section-5-shape-left.png" alt="image" className="img-fluid pricing-section-5-shape pricing-section-5-shape-left"/>
    <img src="/img/pricing-section-5-shape-right.png" alt="image" className="img-fluid pricing-section-5-shape pricing-section-5-shape-right"/>
  </section>
    </>
  )
};
